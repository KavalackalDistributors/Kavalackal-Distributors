...
(function() {
    ...
    // Update createProductElement to add click handler
    ...
    // Update displayProductsByCategory to pass category and index
    const originalDisplayProductsByCategory = displayProductsByCategory;
    displayProductsByCategory = function() {
        const mainContainer = document.querySelector('.section-container');
        mainContainer.innerHTML = '';
